...
export class ExmoComponent implements OnInit {
  ...
  constructor(private http:HttpClient) {
    ...
    const poloniexurl = http.get<Poloniex>('/ccxt/vendor/ccxt/ccxt/mas.php?market=poloniex&syms=BTC/USDT', {headers: headers});
    const okexurl = http.get<Okex>('/ccxt/vendor/ccxt/ccxt/mas.php?market=okex&syms=BTC/USDT', {headers: headers});
    const bitfinexurl = http.get<MarketRaw>('/ccxt/vendor/ccxt/ccxt/mas.php?market=bitfinex&syms=BTC/USD', {headers: headers});
    const hitbtcurl = http.get<Hitbtc>('/ccxt/vendor/ccxt/ccxt/mas.php?market=hitbtc&syms=BTC/USDT', {headers: headers});
    ...
    const lbankurl = http.get<MarketRaw>('/ccxt/vendor/ccxt/ccxt/mas.php?market=lbank&syms=BTC/USDT', {headers: headers});
    const gateiourl = http.get<MarketRaw>('/ccxt/vendor/ccxt/ccxt/mas.php?market=gateio&syms=BTC/USDT', {headers: headers});
