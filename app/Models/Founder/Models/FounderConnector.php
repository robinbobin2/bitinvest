...
abstract class FounderConnector
{
    ...
    public function __construct($options = array())
    {
        ...
        $this->userAgent = 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36'; // 'ccxt/' . $version . ' (+https://github.com/ccxt/ccxt) PHP/' . PHP_VERSION;
    ...
    public function load_markets()
    {
        ...
        return $this->set_markets($markets, null);
    }
    ...
    {
        return isset($this->markets[$symbol]) ? $this->markets[$symbol] : null;
    }
