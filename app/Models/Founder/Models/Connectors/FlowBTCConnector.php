...
class FlowBTCConnector extends FounderConnector
{
    private $coins = ["BTC","LTC","ETH","BCH"];
    ...
    public function search()
    {
        ...
        foreach ($this->coins as $currency) {
            ...
            curl_setopt($curly[$currency], CURLOPT_URL, "https://publicapi.flowbtc.com.br/ticker/" . $currency);
        ...
        curl_multi_close($mh);
        SupplierLog::log("search", json_encode($result), 31);
