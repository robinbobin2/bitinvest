...
class GDaxConnector extends FounderConnector
{
    private $coins = ["BCH-BTC","BCH-USD","BTC-EUR","BTC-GBP","BTC-USD","ETH-BTC","ETH-EUR","ETH-USD","LTC-BTC","LTC-EUR","LTC-USD","BCH-EUR"];
    ...
    public function search()
    {
        ...
        foreach ($this->coins as $currency) {
            ...
            curl_setopt($curly[$currency], CURLOPT_URL, "https://api.gdax.com/products/" . $currency . "/ticker");
