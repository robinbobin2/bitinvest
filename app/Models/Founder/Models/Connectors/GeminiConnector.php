...
class GeminiConnector extends FounderConnector
{
    private $coins = ["btcusd","ethbtc","ethusd","zecusd","zecbtc","zeceth"];
    ...
    public function search()
    {
        ...
        foreach ($this->coins as $currency) {
            ...
            curl_setopt($curly[$currency], CURLOPT_URL, "https://api.gemini.com/v1/pubticker/" . $currency);
