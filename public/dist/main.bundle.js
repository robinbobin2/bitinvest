...
module.exports = "<section class=\"mining-filter\">\n  <div class=\"filter-top\">\n    <h2>Настройка фильтров</h2>\n    <a href=\"blatant-mining.html\" class=\"close\">×</a>\n  </div>\n  <div class=\"categories-block\">\n    <h2>Алгоритм валюты</h2>\n    <ul class=\"tag-list\">\n      <li *ngFor=\"let data of algoFilter\"><a (click)=\"algorithm=data\" [ngClass]=\"algorithm==data ? 'active' : '' \">{{data}}</a> </li>\n    </ul>\n  </div>\n  <div class=\"categories-block\">\n    <h2>Статус проекта</h2>\n    <ul class=\"tag-list\">\n      <li *ngFor=\"let data of yearFilter\"><a [ngClass]=\"status=='both' ? 'active':''\" (click)=\"status='both'\" >Платит/Ожидание</a> </li>\n      <li *ngFor=\"let data of yearFilter\"><a [ngClass]=\"status=='2' ? 'active':''\" (click)=\"status='2'\">Не платит</a> </li>\n    </ul>\n  </div>\n  <div class=\"sorting\">\n    <h2>Сортировка</h2>\n    <form>\n      <p>\n        <input type=\"radio\" id=\"test1\" name=\"radio-group\" checked>\n        <label for=\"test1\" (click)=\"order='name'; reverse=false\">По алфавиту (от А до Я)</label>\n      </p>\n      <p>\n        <input type=\"radio\" id=\"test2\" name=\"radio-group\" checked>\n        <label for=\"test2\" (click)=\"order='name'; reverse=true\">По алфавиту (от Я до А)</label>\n      </p>\n      <p>\n        <input type=\"radio\" id=\"test3\" name=\"radio-group\" checked>\n        <label for=\"test3\" (click)=\"order='proc'; reverse=false\">Доход на уменьшение</label>\n      </p>\n      <p>\n        <input type=\"radio\" id=\"test4\" name=\"radio-group\" checked>\n        <label for=\"test4\" (click)=\"order='proc'; reverse=true\">Доход на увеличение</label>\n      </p>\n      <p>\n        <input type=\"radio\" id=\"test5\" name=\"radio-group\" checked>\n        <label for=\"test5\" (click)=\"order='depo'; reverse=true\">Депозит на уменьшение</label>\n      </p>\n      <p>\n        <input type=\"radio\" id=\"test6\" name=\"radio-group\" checked>\n        <label for=\"test6\" (click)=\"order='depo'; reverse=false\">Депозит на увеличение</label>\n      </p>\n\n    <a [routerLink]=\"['/cloud-mining/all']\" [queryParams]=\"{order: order, reverse: reverse, status:status }\" class=\"saveinput\" >Сохранить</a>\n    </form>\n    <a href=\"#\" class=\"claer\" (click)=\"algorithm = ''\">X Очистить параметры фильтрации </a>\n\n  </div>\n</section>"
