    ...
    ExchangesComponent.prototype.ngOnInit = function () {
        ...
        this.stockService.getExchanges().subscribe(function (res) {
            ...
            var _loop_1 = function (item) {
                item.load = false;
                _this.stocks.push(_this.stockService.getExchangePairs(item.name).takeWhile(function () { return _this.alive; }).map(function (pairs) { item.count = pairs.length; item.load = true; }));
            };
