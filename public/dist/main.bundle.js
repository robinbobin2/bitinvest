        ...
        this.stockService.getExchanges().subscribe(function (res) {
            ...
            _this.stockService.getVolumes().subscribe(function (res) {
                ...
                for (var _b = 0, _c = _this.exchanges; _b < _c.length; _b++) {
                    var item = _c[_b];
                    item.btc = _this.exchange_volumes[item.name].btc;
