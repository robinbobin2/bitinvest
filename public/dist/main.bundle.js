    ...
    CryptoComponent.prototype.ngOnInit = function () {
        ...
        this.stocksData = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["a" /* Observable */].interval(1000).take(50).concatMap(function () {
            ...
            for (var _i = 0, _a = _this.stocks; _i < _a.length; _i++) {
                var item = _a[_i];
                if (_this.volume === 0) {
                    for (var _b = 0, _c = _this.stocks; _b < _c.length; _b++) {
                        var item_1 = _c[_b];
                    ...
                    _this.volume = 0;
                    for (var _d = 0, _e = _this.stocks; _d < _e.length; _d++) {
                        var item_2 = _e[_d];
        ...
        this.cryptoData = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["a" /* Observable */].interval(2000).concatMap(function () { return _this.stocksService.getCrypto(); })
            .map(function (response) {
            _this.animtype = '';
            _this.animtypebg = '';
            if (_this.dataUsd.now != response[symbol + '/USDT'].now) {
                ...
                if (_this.dataUsd.now > response[symbol + '/USDT'].now) {
                    ...
                    _this.animtypebg = 'redbgw';
                }
                else {
                    _this.animtypebg = 'greenbgw';
