...
var PortfolioComponent = (function () {
   ...
   */
    ...
    PortfolioComponent.prototype.onSearch = function (type, terms) {
        var _this = this;
        this.searchService.search(terms, type)
            .subscribe(function (results) {
            _this.results = results;
            console.log(results);
        });
