...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <h3>Биржи</h3>
             <div style="float:right"><a href="{{route('exchanges.create')}}">Добавить</a></div></div>
                        ...
                        @foreach($news as $n)
                          <tr>
                              ...
                              <td>
                                  ...
                                  <form id="delete-news-{{$n->id}}" action="{{route('exchanges.destroy', $n->id)}}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
