        ...
        <div class="col-md-12 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/admin/interview" enctype="multipart/form-data">
                        {{ csrf_field() }}
<div ></div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="name_credits" class="col-md-4 control-label">Фамилия, Имя и Отчество</label>
